...
//  * However, they may also be more broadly useful.  A goal for future
//  * work would be to make the site and the underlying data less
//  * tightly coupled.  But for now, we're just making a slot in
//  * replacement, not fiddling with the vue.
//  */
// @Module({
//   namespaced: true,
//   name: "treemap",
// })
// default export class Treemap  {
